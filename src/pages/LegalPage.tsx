...
const webDocuments: Record<'privacy' | 'terms', LegalDocument> = {
  ...
  terms: {
    ...
    sections: [
      ...
      { id: 'contacto', title: '6. Cambios y contacto', paragraphs: ['Las modificaciones se publicarán en esta página con su fecha de actualización. Para consultas sobre el sitio y estas condiciones, escribe a contacto@mictlanlabs.com.mx.'] },
    ...
    <div className="flex min-h-svh flex-col bg-background text-foreground">
      ...
      <main id="contenido-legal" className="mx-auto w-full max-w-4xl flex-1 px-4 py-10 sm:px-6 sm:py-16">
        ...
        <aside aria-label="Contacto de MictlanLabs" className="mt-10 rounded-2xl border border-border bg-card p-5 sm:p-6">
          ...
          <a href="mailto:contacto@mictlanlabs.com.mx" className="inline-flex min-h-11 max-w-full items-center break-all py-2 underline underline-offset-4 focus-visible:outline-2 focus-visible:outline-offset-4">contacto@mictlanlabs.com.mx</a>
